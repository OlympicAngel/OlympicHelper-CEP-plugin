...
class EffectAttrValue{
    ...
    GetValueByTime(atTime)
    {
        ...
        if(beforeValue.Easing == 2 || beforeValue.Easing == 3)
            outEase = 0.6;
        if(afterValue.Easing == 1 || afterValue.Easing == 3)
            inEase = 0.4;
    ...
    GenerateKeyframes(jumpInterval,jsx = false)
    {
        ...
        for(var x = startTime; x <= endTime + jumpInterval; x += jumpInterval )
        {
