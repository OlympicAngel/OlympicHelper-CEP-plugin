class EffectUI{
    ...
    get CurrentTime(){return Math.floor(this.pointerX / this.timelinePixels * this.timelineLength*100)/100};
    ...
    Render()
    {
        ...
        for (const key in this.items) {
            ...
            input.onfocusout = this.onInputChange.bind(this,input);
        ...
        jq_timePointer.draggable({
            ...
            start: function(){window.onDrag = true;},
            stop: function(){setTimeout(function(){ window.onDrag = false;},1)},
        });
    ...
    //#region minimize
    static get type(){return {units:"units",relative:"relative", checkbox:"checkbox"}}
    ...
    onInputChange(elemnt)
    {
        ...
        if(elemnt.value == undefined || elemnt.value == "" || elemnt.value == null || isNaN(elemnt.value))
        {
            elemnt.value = this.value;
        }
    ...
    RenderKeyFrame(key,timeline)
    {
        ...
        jq_keyframe.draggable({
            ...
            stop: function(event,ui){setTimeout(function(event,ui){
                window.onDrag = false;
            ...
            }.bind(this,event,ui),1)}.bind(this),
        });
